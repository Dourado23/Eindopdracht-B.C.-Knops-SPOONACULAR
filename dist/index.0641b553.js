...
async function fetchRecipes(ingredientName) {
    ...
    try {
        let ingredients;
        const result = await _axiosDefault.default.get(`https://api.spoonacular.com/recipes/findByIngredients?ingredients=${ingredientName}&number=20&apiKey=${api}`, {});
...
},{}]},["jKwHT","bNKaB"], "bNKaB", "parcelRequired72d")
